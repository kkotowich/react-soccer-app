...
export default class TeamStats extends Component {
  ...
  render() {
    ...
    const defence = Math.round((duelTackling + fieldCoverage + blockingAbilities + gameStrategy + playmakingRisks)/5);
    const offence = Math.round((kickingAbilities + ballManipulation + passingAbilities + fieldCoverage + gameStrategy + playmakingRisks)/6 )
      ...
      datasets: [
        {
          ...
          data: [
            ballManipulation, kickingAbilities, passingAbilities, duelTackling
            , fieldCoverage, blockingAbilities, gameStrategy, playmakingRisks ]
        }
      ]
    };
      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col s12 m5">
            ...
            <Divider />
            <h4>Team's Offence: {offence}%</h4>
            <h4>Team's Defence: {defence}%</h4>
